...
public class VehicleDataObj {
	...
	public String toHiveString() {
		...
		if (nevChargeSystemTemperatureDtoList != "") resultString.append(nevChargeSystemTemperatureDtoList).append("\t"); else resultString.append("NULL").append("\t");
		resultString.append("NULL").append("\t");
