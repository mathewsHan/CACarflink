 ...
 */
public class VehicleDataAccuracyDayTask {
	...
	public static void main(String[] args) throws Exception {
		...
		String querySql = "SELECT srcTotalNum, errorTotalNum FROM " +
			"(SELECT COUNT(1) AS srcTotalNum FROM vehicle_ods.vehicle_src WHERE dt = '"+ yesterdayDate +"') src, " +
			"(SELECT COUNT(1) AS errorTotalNum FROM vehicle_ods.vehicle_error WHERE dt = '"+ yesterdayDate +"') error" ;
